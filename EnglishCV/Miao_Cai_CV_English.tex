...
\begin{document}
	...
	\begin{itemize}[leftmargin=0ex,itemsep=0ex]
		...
		\begin{minipage}[t]{0.8\linewidth}
			17 SCI/SSCI indexed peer-reviewed articles (5 first/corresponding author),\\
			14 peer-reviewed Chinese articles (5 first/corresponding author).\\
			1 book chapter
		\end{minipage}
	
		\item \textbf{Academic impact}: citations: 165; $\,$ H-index: 7; $\,$ I10-index: 5.
	\end{itemize}
