...
\noindent
\years{R}Everyday R user: Rmarkdown, ggplot2, knitr, dplyr, Shiny, Rstan$\dots$\\
	\years{PYTHON}Experienced Python user: pandas, numpy, dask, h2o, tensorflow\\
...
\underline{Miao Cai}, Echu Liu, Steven E. Rigdon, Zhengmin Qian, Rhonda BeLue, Jen Jen Chang. "Validating Two Multiple Indicators and Three Single Numeric Score Charlson or Elixhauser Comorbidity Indices Among the Population of Shanxi, China", submitted to \emph{Medical Care}.\\
